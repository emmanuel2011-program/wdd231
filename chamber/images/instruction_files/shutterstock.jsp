			...
			try {
				...
				if (!usi_app.suppress_page) {
					...
					if(usi_app.url.full.match('offset') != null ||
							...
							(usi_app.is_checkout_page && document.querySelector('.mui-11dhz1l-PrimaryLayout-main').textContent.indexOf('Enhanced License') != -1)) {
					...
					if(document.querySelector('.mui-b7eh1n-actionsConversionContainer') != null && document.querySelector('.mui-b7eh1n-actionsConversionContainer').textContent.indexOf('Premium Content') != -1) {
